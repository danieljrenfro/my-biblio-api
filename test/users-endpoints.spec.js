...
describe('User Endpoints', function () {
  ...
  describe(`POST /api/user`, () => {
    context(`User Validation`, () => {
      ...
      it(`responds 400 'Password must be 8 or more characters' when password less than 8 characters`, () => {
      ...
      it(`responds 400 error when password starts with spaces`, () => {
        ...
        return supertest(app)
          ...
          .expect(400, { error: 'Password must not begin or end with empty spaces' });
      });
